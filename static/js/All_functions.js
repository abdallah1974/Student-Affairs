...
function savedata() {
    ...
    //         alert("this student has been added before , please check id and email again");
    //     } else {
...
$(document).on('submit','#sub',function(e) {    
    $.ajax({
        ...
        data: {
            ...
            let message = data;
            if(message === "Error: Student already exists")
            {
                alert("this student has been added before , please check id and email again");
            }
            else
...
function removeStudent() {
    ...
    $.ajax({
        ...
        error: function (xhr, textStatus, errorThrown) {
            alert("Error removing student: " + errorThrown);  // Show an error message
        }
    });
}

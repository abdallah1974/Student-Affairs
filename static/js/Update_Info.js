...
function rst() {
    console.log("asiauhdiuawd");

    var registeredDate = "{{ registered.date }}";
    var formattedDate = new Date(registeredDate).toISOString().split('T')[0];
    
    document.getElementById("Fname").value = "{{ registered.Fname }}";
    document.getElementById("Lname").value = "{{ registered.Lname }}";
    document.getElementById("id").value = "{{ id }}";
    document.getElementById("date").value = formattedDate;
    document.getElementById("gpa").value = null;
    document.getElementById("level").value = null;
    document.getElementById("gender").value = "{{ registered.gender }}";
    document.getElementById("status").value = null;
    document.getElementById("email").value = null;
    document.getElementById("phone").value = null;
    document.getElementById("dep").value = "{{ registered.dep }}";
}
